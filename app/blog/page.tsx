...
export const metadata: Metadata = {
  ...
  keywords:
    'блог про Львів, історія Львова, легенди Львова, архітектура Львова, кава Львів, статті про Львів',
  alternates: {
...
const blogPosts = [
  ...
  {
    slug: 'ekskursiya-lviv-samostijno',
                  ...
                  >
                    <Link href={`/blog/${post.slug}`}>
                      <div className="p-6">
                        ...
                        <h2 className="mb-3 text-2xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors">
                          {post.title}
                        </h2>
