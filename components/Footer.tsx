        ...
        <div className="mb-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <p className="leading-relaxed text-gray-400">
              Я показую Львів через деталі, які більшість не помічає. Історія міста без сухих дат — через людей, сенси
              та розуміння міста. Після моїх екскурсій Львів запам’ятовується назавжди.
            </p>
          </div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li>
                ...
                >
                  ...
                  <span className="font-semibold">+380 97 538 33 48 (Telegram, Viber)</span>
                </a>
              </li>
              <li>
                <a
                  href="mailto:krasiraira@gmail.com"
                  className="group flex items-center space-x-3 transition-colors hover:text-purple-400"
                >
                  <svg className="h-5 w-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                  ...
                  <span>krasiraira@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
